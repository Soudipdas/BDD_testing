...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Login", "  In order to login to maintain employee records\r\n  As an user\r\n  I want to login" +
                    " into the portal ", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [Xunit.InlineDataAttribute("lolpku", "lolpku123", "Invalid credentials", new string[0])]
        [Xunit.InlineDataAttribute("binod", "binod123", "Invalid credentials", new string[0])]
